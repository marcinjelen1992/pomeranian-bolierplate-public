...
export const JsObjectsExercises = () => {
  let nameOfProp = 1;
  const person = {
    name: 'John',
    age: 34,
  ...
  // Spread operator
  // Pozwala na destrukturyzowanie obiektu, pozwala tworzyć obiekt z innego obiektu i nadpisać w nim pole
