  ...
  return (
    <>
      ...
      <div className="faked-tags">
        <div className="headerone">Tytuł</div>
        <div className="smallreplacement">05.2023</div>
        <div className="headerthreefirst">
        ...
        <div className="headerthreesecond">
        ...
        <span>
          ...
          <div className="unorderedlistreplacement">
            <div className="listelementreplacement">Todo 1</div>
            <div className="listelementreplacement">Todo 2</div>
            <div className="listelementreplacement">Todo 3</div>
          </div>
        </span>
      </div>
    </>
